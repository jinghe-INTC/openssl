...
static const ERR_STRING_DATA EVP_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_EVP, EVP_F_EVP_PKEY_GET0_SM9, 0), "EVP_PKEY_get0_SM9"},
    {ERR_PACK(ERR_LIB_EVP, EVP_F_EVP_PKEY_GET0_SM9MASTERSECRET, 0), "EVP_PKEY_get0_SM9MasterSecret"},
    {ERR_PACK(ERR_LIB_EVP, EVP_F_EVP_PKEY_GET0_SM9PUBLICPARAMETERS, 0), "EVP_PKEY_get0_SM9PublicParameters"},
    {ERR_PACK(ERR_LIB_EVP, EVP_F_EVP_PKEY_GET0_SM9_MASTER, 0), "EVP_PKEY_get0_SM9_MASTER"},
...
static const ERR_STRING_DATA EVP_str_reasons[] = {
    ...
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_EXPECTING_A_SM9_KEY), "expecting a sm9 key"},
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_EXPECTING_A_SM9_MASTER_KEY), 
    "expecting a sm9 master key"},
    {ERR_PACK(ERR_LIB_EVP, 0, EVP_R_EXPECTING_A_SM9_MASTER_SECRET), 
